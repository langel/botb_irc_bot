...
module.exports = {
	...
	help: function(info, words) {
		...
		var command_help_text = {
			...
			ultrachord: "Usage: " + prefix + "ultrachord <notes> [timbre] | Returns a URL to a .wav file of the notes and timbre provided, in a format such as 'C4 E4 G4 sawtooth'. Available notes range from C0 to B7. If number is omitted it will pick octave " + ultrachord.default_octave + ". Default timbre is sine. Available timbres are sine, sawtooth, square, triangle, and pluck.",

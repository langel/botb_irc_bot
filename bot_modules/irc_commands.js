...
module.exports = {
	...
	help: function(info, words) {
		...
		var command_help_text = {
			...
			ultrachord: "Usage: " + prefix + "ultrachord [timbre] <notes> | Returns a URL to a .wav file of the notes and timbre provided, in a format such as 'sawtooth C4 E4 Bb4 D#5'. Available notes range from C0 to B7. If number is omitted it will pick octave " + ultrachord.default_octave + ". Default timbre is square. Available timbres are: " + ultrachord.timbres.join(", ") + ".",
